function navbar(){
    ...
    <div id="navbar">
        <div id="nav-a" onclick = "window.location.href = './index.html'">
            <img src="https://bit.ly/3nBvG0c" alt="Optimistic" id="img" width="">
        </div>
        <div id="nav-b">
            <div>
            <select>
            ...
            <div>
                ...
                <input type="search" id="search" placeholder="Search the Optimistic seller catalog..">
            </div>
            <div>
        ...
        <div id="nav-c" onmouseover="windOpen()" onmouseout="windClose()">
            ...
            <div class="flag" id="wind">
                ...
                <h6>By sliding to continue or create an account, <br> I agree to the <a href="index.html">Optimistic policy</a> </h6>
                <h2 style="color: black;">Optimistic Seller Portal</h2>
                </div>
        </div>
        <div id="nav-d">
    ...
    <div id="bot-nav">
        <div>
            <div id="left_first"><i class="fa-solid fa-list"></i>
                Seller views    <i class="fa-solid fa-angle-up"></i>
                <!-- </div> -->
                <div id="menu">
                  
                        <div><a href="./carpart.html">Machinery / Vehicles & Accessories </a>
                            <!-- <ul>
                        ...
                        <div><a href="./apparels.html">Apparel / Fashion Accessories /Timepieces,Jewelry</a>
                            <!-- <ul>
                        ...
                        <div><a href="./products.html">Lights & Lighting / Construction & Real Estate</a>
                            <!-- <ul>
                        ...
                        <div><a href="./homepart.html">Home & Garden / Furniture</a>
                            <!-- <ul>
                        ...
                        <div><a href="./products.html">Fabric & Textiles Raw Material / Home Textiles</a>
                            <!-- <ul>
                        ...
                        <div><a href="./products.html">Beauty & Personal Care / Health & Medical</a>
                            <!-- <ul>
                        ...
                        <div><a href="./products.html">Packaging & Printing / Office & School Supplies</a>
                            <!-- <ul>
                        ...
                        <div><a href="./electronics.html">Electrical Equipment & Supplies</a>
                            <!-- <ul>
                                <li><a href="#">Sub Menu 1</a></li>
                                <li><a href="#">Sub Menu 2</a></li>
                                <li><a href="#">Sub Menu 3</a></li>
                        ...
                        <div><a href="./products.html">Tools & Hardware / Security & Protection / Fabrication Service</a>
                            <!-- <ul>
                                <li><a href="#">Sub Menu 1</a></li>
                                <li><a href="#">Sub Menu 2</a></li>
                                <li><a href="#">Sub Menu 3</a></li>
            ...
            <div>
                <a href="./products.html">Ready to Ship</a>
            </div>
            <div>
                <a href="./products.html">Personal Protective E...</a>
            </div>
            <div>
                <a href="./products.html">Trade Shows</a>
            </div>
            <div id="blogslide">
                <a href="./buyer-dashboard.html">Buyer Hub <i class="fa-solid fa-angle-up"></i></a>
            ...
            <div>
                <a href="./seller-dashboard-v2.html">Sell on Optimistic <i class="fa-solid fa-angle-up"></i></a>
            </div>
            <div>
                <a href="./contact.html">Help <i class="fa-solid fa-angle-up"></i></a>
            </div>
        </div>
        <div>
            <div>

# Optimistic Seller Portal

![Optimistic](https://optimistic-marketplace.netlify.app/static/images/brand/logo-full.png)

# Welcome :wave:

### About Optimistic:

> Optimistic is the seller-facing storefront for this marketplace rebuild, with buyer and sys admin surfaces to follow.
...
## deployment Link:-
https://optimistic-marketplace.netlify.app/
...
- `Additional Features` : Kept the Optimistic branding, fonts, colors, styling and favicon consistent throughout the seller-facing storefront.
